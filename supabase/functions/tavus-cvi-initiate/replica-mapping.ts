...
export function generatePersonalizedScript(
  ...
  if (conversationType === 'practice') {
    return `This is a practice conversation with a user who has just completed a course on ${courseTopic}. The main focus area they've been studying is: ${moduleSummary}. This is an informal, friendly discussion to help them apply their knowledge practically. Ask open-ended questions about real-world applications, encourage them to share their thoughts, and provide supportive feedback. Keep the tone conversational and encouraging.`
  } else {
    return `This is a formal oral examination for a suer who has completed a comprehensive course on ${courseTopic}. The examination focuses on: ${moduleSummary}. Conduct a thorough academic assessment by asking detailed questions about core concepts, theoretical understanding, and practical applications. Maintain a professional tone while being fair and encouraging. Test their depth of knowledge and ability to explain complex concepts clearly.`
  }
}
...
export function generateCustomGreeting(
  ...
  if (conversationType === 'practice') {
    return `Hello! Congratulations on completing your course on ${courseTopic}. I'm excited to have a friendly conversation with you about what you've learned. Let's explore how you might apply this knowledge in real-world situations. What aspect of the course did you find most interesting?`
  } else {
    return `Good day. Welcome to your oral examination for the course on ${courseTopic}. This is your opportunity to demonstrate your knowledge and analytical thinking. Are you ready to begin?`
  }
}